...
public class EventDatabase implements Queryable {
    ...
    public void initSchema() {
        ...
        try (Statement stmt = connection.createStatement()) {
            ...
            throw new RuntimeException(
                    "Could not create file_events table: "
                            + e.getMessage(),
                    e
            );
        }
